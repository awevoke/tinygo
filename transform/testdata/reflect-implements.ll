...
@"reflect/types.type:named:error" = internal constant { i8, i16, ptr, ptr, ptr } { i8 52, i16 0, ptr @"reflect/types.type:pointer:named:error", ptr @"reflect/types.type:interface:{Error:func:{}{basic:string}}", ptr null }, align 4
@"reflect/types.type:interface:{Error:func:{}{basic:string}}" = internal constant { i8, ptr, ptr } { i8 20, ptr @"reflect/types.type:pointer:interface:{Error:func:{}{basic:string}}", ptr null }, align 4
@"reflect/types.type:pointer:interface:{Error:func:{}{basic:string}}" = internal constant { i8, ptr, ptr } { i8 21, ptr @"reflect/types.type:interface:{Error:func:{}{basic:string}}", ptr null }, align 4
@"reflect/types.type:pointer:named:error" = internal constant { i8, i16, ptr, ptr } { i8 21, i16 0, ptr @"reflect/types.type:named:error", ptr null }, align 4
@"reflect/types.type:pointer:named:reflect.rawType" = internal constant { ptr, i8, i16, ptr, ptr } { ptr null, i8 21, i16 0, ptr null, ptr null }, align 4
